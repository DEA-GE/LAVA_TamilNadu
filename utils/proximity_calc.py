...
def generate_distance_raster(
    shapefile_path, region_gdf, output_path, pixel_size=0.01, no_data_value=-9999
):
    """
    ...
    dr_obj = dr.DistanceRaster(  # noqa: F841
        rv_array, affine=affine, output_path=output_path, conditional=raster_conditional
    )
